...
public class Responder
{
    ...
    /**
     * Generate a response using the given words as
     * triggers for a plausible response. Return a
     * random response if no matching word is found
     * in the input.
     * @param words The unique words of the user's input.
     */
